...
export default function DeepDiveScreen() {
  ...
  // Screenshot protection (Deep Dive is premium content)
  useEffect(() => {
  ...
  // Handle exporting the entire Deep Dive screen
  async function exportFullDeepDive() {
    if (!premium) {
      router.push({
        pathname: "/paywall",
        params: { reason: "deep-dive" },
      });
      return;
    }
    ...
    router.push({
      pathname: "/share-card",
      params: { data: JSON.stringify(analysis), mode: "deep-dive-full" },
    });
  }
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#1F2F38" }}>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          {!premium && <LockedBadge label="Unlock Full Archetype" />}
        </View>
        ...
        <View style={styles.card}>
          ...
          {premium && (
            <>
              <View style={styles.subSection}>
                <Text style={styles.subLabel}>Top Takeaways</Text>
        ...
        {/* EXPORT FULL DEEP DIVE */}
        <TouchableOpacity
          style={styles.primaryButton}
          onPress={exportFullDeepDive}
        >
          <Text style={styles.primaryText}>
            {premium ? "Export Full Deep Dive" : "Unlock to Export Full Deep Dive"}
          </Text>
        </TouchableOpacity>
